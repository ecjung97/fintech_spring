...
<%-- action 매핑주소를 생략하면 이전 매핑주소인  board_write가 action속성값이 된다.즉 이전 매핑주소가 action매핑주소가 된다.
동일 매핑주소 구분은 메서드 방식으로 구분(get , post) 한다. --%>
 <table border="1">
  ...
  <tr>
   <th>글쓴이</th>
   <td><input name="writer" id="writer" size="14" placeholder="글쓴이 입력" /><br/>
       <span id="error_writer"></span>
   </td>
   </tr>
   <tr>
    <th>글제목</th>
    <td><input name="title" id="title" size="36" placeholder="글제목 입력" /><br/>
  ...
  <tr>
   <th>글내용</th>
   <td>
   <textarea name="content" id="content" rows="10" cols="36" placeholder="글내용 입력"></textarea><br/>
