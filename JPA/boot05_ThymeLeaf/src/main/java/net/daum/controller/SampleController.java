...
public class SampleController {
	...
	public ModelAndView start_thymeLeaf() {
		...
		tm.setViewName("./thymeLeaf/start");
		//타임리프(ThymeLeaf) 뷰페이지 경로가 src/main/resources/templates/thymeLeaf/start.html
		return tm;
	}
	...
	@RequestMapping(value="/sample3",method=RequestMethod.GET) //get 으로 접근하는 매핑주소 처리, sample3 매핑주소 등록
	...
	public ModelAndView sample06() {
		...
		ModelAndView sm = new ModelAndView("result06");//생성자 인자값에 뷰페이지 경로는 src/main/resources/templates/result
		//06.html
	...
	public void sample07(Model model) {
		...
		model.addAttribute("options", Arrays.asList("AAAA","BBB","CCC","DDD")); //Arrays.asList()는 배열을 컬렉션 List로
		//변환		
	}
}
