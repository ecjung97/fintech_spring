         ...
         <table id="mJoin_t">
            <tr>
               ...
               <td><input name="mem_id" id="mem_id" size="14"
                  class="input_box" /> <button type="button" class="input_b"
                  onclick="id_check();">아이디중복체그</button> <br /> <span
                  id="idcheck"></span></td>
            </tr>
            <tr>
               <th>비밀번호</th>
            ...
            <tr>
               ...
               <td><input name="mem_zip" id="mem_zip" size="3"
                  ...
                  <button type="button" class="input_b"
                  onclick="post_check();">우편검색</button></td>
            </tr>
            <tr>
               <th>주소</th>
